...
router.post('/', ShopListcontroller.addShop); // Add new shop
router.put('/:id', ShopListcontroller.updateShop); // Update by id (use lowercase name and location to update)
router.delete('/:id', ShopListcontroller.deleteShop); // Delete shop and related data
